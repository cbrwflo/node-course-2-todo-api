...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = "Second uncompleted todo";
  ...
  it('should not complete a todo for another user', (done) => {
    var hexId = todos[0]._id.toHexString();
    var  text = "First completed todo";
...
describe('POST /users', () => {
  ...
  it('should return validation errors if email in use', (done) => {
    var emailAlreadyInUse = users[0].email;
    var password = 'o1k4amPass';

    request(app)
      .post('/users')
      .send({emailAlreadyInUse, password})
      .expect(400)
      .end(done);
    });
  });
...
describe('POST /users/login', () => {
  ...
  it('should reject invalid login', (done) => {
    request(app)
      ...
      .send({
        email: users[1].email,
        password: users[1].email + 'badPasswordFake'
      })
      .expect(400)
      .expect((res) => {
        expect(res.headers['x-auth']).toNotExist();
